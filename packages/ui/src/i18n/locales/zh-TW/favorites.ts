const messages = {
  "favorites": {
    ...
    "manager": {
      ...
      "importDialog": {
        "title": "匯入收藏",
          ...
          "selectFile": "選擇 Zip / JSON / 分享 HTML / 原始 PNG 檔案",
          "uploadHint": "點選或拖曳收藏檔案到此處匯入",
          "supportFormat": "同一入口支援 .po-favorites.zip、.json、分享 .html/.htm、原始 .png",
        ...
        "sharePngMissingData": "該 PNG 未檢測到可匯入的收藏分享資料，請使用原始匯出的 PNG 檔案；截圖、壓縮或格式轉換後的圖片無法匯入。",
        "shareHtmlMissingData": "該 HTML 未檢測到可匯入的收藏分享資料，請使用 Prompt Optimizer 匯出的分享 HTML 檔案。",
    ...
    "share": {
      "title": "匯出分享",
      "action": "分享匯出",
      "hint": "匯出單個收藏資產。核心內容會隨分享檔案一起保留，範例和歷史版本可按需附帶。",
      "sectionsTitle": "分享內容",
      "watermarkTitle": "專案浮水印",
      "projectNamePlaceholder": "專案名稱",
      "projectUrlPlaceholder": "專案位址",
      "fixedSectionsHint": "封面圖、描述、提示詞正文、標籤、變數和專案浮水印會預設包含。",
      "watermarkHint": "浮水印固定顯示 Prompt Optimizer 和官網位址。",
      "previewTitle": "匯出預覽",
      "previewHtml": "HTML",
      "previewPng": "PNG",
      ...
      "previewEmpty": "暫無預覽",
      "previewHint": "預覽內容與匯出檔案保持一致；PNG 匯入需要使用原始匯出檔案。",
      "previewPngAlt": "PNG 分享預覽",
      "previewObjectUrlUnavailable": "目前環境無法顯示 PNG 預覽",
      "originalFileHint": "HTML 最適合閱讀和複製；PNG 匯入僅支援原始匯出檔案。",
      "cancel": "取消",
      "exportHtml": "匯出 HTML",
      "exportPng": "匯出 PNG",
      "exportSuccess": "分享檔案已匯出",
      "exportPartialSuccess": "分享檔案已匯出，但有 {count} 個圖片資源缺失",
      "exportFailed": "分享匯出失敗",
      "sections": {
        "description": "描述",
        "content": "提示詞正文",
      ...
      "document": {
        ...
        "headerImportNote": "匯入：訪問 https://prompt.always200.com/ → 收藏夾 → 匯入 → 上傳此 HTML 檔案。",
        "copy": "複製",
        "copied": "已複製",
        "copyFailed": "複製失敗",
        "mode": "模式",
        "input": "輸入",
        "output": "輸出",
        "importNoteTitle": "匯入說明",
        "current": "目前",
        "htmlImportNoteBody1": "匯入：訪問 https://prompt.always200.com/ → 收藏夾 → 匯入 → 上傳此 HTML 檔案。",
        "htmlImportNoteBody2": "請使用原始 HTML 檔案恢復內嵌資料和圖片。",
        "pngImportNoteText": "匯入：訪問 https://prompt.always200.com/ → 收藏夾 → 匯入 → 上傳原始 PNG 檔案。\n必須使用原圖；截圖、壓縮、轉格式或重新儲存會遺失匯入資料。",
        "exampleTitle": "範例 {index}",
        "exampleOutputAlt": "範例 {index} 輸出",
        "exampleInputAlt": "範例 {index} 輸入",
        "versionTitle": "v{version}",
        "versionTitleCurrent": "v{version} · {current}",
        "parameterSummary": "{count} 個參數",
        "outputImageSummary": "{count} 張輸出圖",
        "inputImageSummary": "{count} 張輸入圖"
      }
    },
    "dialog": {
        "createTitle": "新建收藏",
